  ...
  return (
    <div>
      ...
      <p>
        ...
        contact us at freshaire@gmail.com. <br />
        <br />
        ...
        packaging. You’ll also need the receipt or proof of purchase. If your
        ...
        us without first requesting a return will not be accepted. If your
        return is accepted, we’ll send you a return shipping label, as well as
        instructions on how and where to send your package.
        <br />
        <br /> Items sent back to us without first requesting a return will not
        be accepted. You can always contact us for any return question at
        freshaire@gmail.com. Damages and issues Please inspect your order upon
        ...
        plants), custom products (such as special orders or personalized items),
        ...
        method within 10 business days. Please remember it can take some time
        ...
        return, please contact us at freshaire@gmail.com.
      </p>
    </div>
  );
};
